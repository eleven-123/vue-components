...
function calculateRightBottom(style, curPositon, proportion, needLockProportion, pointInfo) {
  ...
  if (needLockProportion) {
    ...
    const rotatedBottomRightPoint = calculateRotatedPointCoordinate(newBottomRightPoint, newCenterPoint, style
      .rotate)
...
function calculateTop(style, curPositon, proportion, needLockProportion, pointInfo) {
  ...
  const newHeight = Math.sqrt((rotatedTopMiddlePoint.x - symmetricPoint.x) ** 2 + (rotatedTopMiddlePoint.y -
    symmetricPoint.y) ** 2)
...
function calculateRight(style, curPositon, proportion, needLockProportion, pointInfo) {
  ...
  const newWidth = Math.sqrt((rotatedRightMiddlePoint.x - symmetricPoint.x) ** 2 + (rotatedRightMiddlePoint.y -
    symmetricPoint.y) ** 2)
...
function calculateBottom(style, curPositon, proportion, needLockProportion, pointInfo) {
  ...
  const newHeight = Math.sqrt((rotatedBottomMiddlePoint.x - symmetricPoint.x) ** 2 + (rotatedBottomMiddlePoint.y -
    symmetricPoint.y) ** 2)
...
function calculateLeft(style, curPositon, proportion, needLockProportion, pointInfo) {
  ...
  const newWidth = Math.sqrt((rotatedLeftMiddlePoint.x - symmetricPoint.x) ** 2 + (rotatedLeftMiddlePoint.y -
    symmetricPoint.y) ** 2)
...
export default function calculateComponentPositonAndSize(name, style, curPositon, proportion, needLockProportion,
  pointInfo) {
